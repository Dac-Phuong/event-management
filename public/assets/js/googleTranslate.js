  ...
  */
        ...
        var Ld = function (a, b, c, d) {
            for (var e = 0; e < a.length; ++e) {
                var f = a[e];
                if (!f.sc && f.listener == b && f.capture == !!c && f.bd == d)
                    return e;
            }
            return -1;
        };
  ...
  */
        ...
        var bf = function (a) {
            ...
            ef = function (a, b, c) {
                ...
                0 < b.length &&
                    (0 === a.l.length ? a.N(b) : (a.h.push(b), bf(a)));
                return e;
            },
        ...
        var ff = function (a, b) {
            ...
            $e = function (a) {
                a.j == a.F &&
                    ((a.j = null),
                    a.F.onLoad((0, _.A)(a.yf, a)) &&
                        gf(a, new Db.Ja(Db.Ja.g.Dd)),
                    bf(a));
            },
            na = function (a) {
                if (a.j) {
        ...
        _.Bf = function (a, b, c) {
            if (a.forEach && "function" == typeof a.forEach) a.forEach(b, c);
                ...
                for (
                    var d = _.Af(a), e = _.zf(a), f = e.length, g = 0;
                    g < f;
                    g++
                )
        ...
        Ag.prototype.toString = function () {
            if (this.h.endsWith("_/wa/"))
                var a = this.h + Bg(this, "wk") + this.l;
            else {
                a = this.h + Cg(this);
                var b = this.j;
                var c = [],
        ...
        var hh = function (a) {
                if (
                    ...
                    if (a.A && 4 == _.ih(a)) _.Yg(a.P, 0, a);
                        ...
                        (a.dispatchEvent("readystatechange"), 4 == _.ih(a))
                    ) {
                        a.h = !1;
                        try {
                            a.oc()
    ...
    try {
        ...
        MSG_SELECT_LANGUAGE = "Vietnamese";
...
(function () {
    ...
    (function () {
        ...
        c._cl = "en-US";
        c._cuc = "loadGoogleTranslate";
        c._cac = "";
        c._cam = "";
        c._cenv = "prod";
        c._cll = "INFO";
        c._ctkk = "474998.2677934915";
