            ...
            <div class="row gx-0 gy-6 g-lg-10">
                <div class="col-lg-5">
                    ...
                    <form class="footer-form">
                        ...
                        <div class="d-flex mt-1">
                            ...
                            <button type="submit"
                                class="btn btn-primary shadow-none rounded-0 rounded-end-bottom rounded-end-top waves-effect waves-light">
                                Subscribe
                            </button>
                        </div>
                    </form>
                ...
                <div class="col-lg-2 col-md-4 col-sm-6">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-4">
                            <a href="checkout-page.html" class="footer-link">Dịch vụ</a>
                        </li>
                        <li class="mb-4">
                            <a href="help-center-landing.html" class="footer-link">Tuyển dụng</a>
                        </li>
                    </ul>
                </div>
