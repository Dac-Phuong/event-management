                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
                    <div class="timeline-2">
                        <div class="timeline-container">
                            <div class="timeline-card"><a class="active" href="{{ url('/du-an') }}"
                                    style="cursor: pointer;">Tất cả</a></div>
                            @foreach ($data['category'] as $category)
                                <div class="timeline-card"><a href="{{ url('/du-an/' . $category->slug) }}"
                                ...
                                <div class="box-img"><img src="{{ $item->thumbnail }}" alt="{{ $item->title }}"
                                    ...
                                    <div class="service-title-block">
                                        <div class="service-name portforlio-page"> <a
                                                href="{{url('/du-an/' . $item->category->slug . '/' . $item->slug)}}">
                                                {{ $item->title }}
                                            </a></div>
