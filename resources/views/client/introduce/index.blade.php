                ...
                <div class="col-12">
                    <ul class="timeline timeline-center mt-12">
                        <li class="timeline-item">
                            <span class="timeline-indicator timeline-indicator-primary aos-init aos-animate"
                        ...
                        <li class="timeline-item">
                            <span class="timeline-indicator timeline-indicator-success aos-init aos-animate"
                                data-aos="zoom-in" data-aos-delay="200">
                                            ...
                                            <div class="mb-4 w-100">
                                                <div class="progress bg-label-danger" style="height: 6px;">
                                                    <div class="progress-bar bg-danger" role="progressbar"
                                                        style="width: 48.7%" aria-valuenow="25" aria-valuemin="0"
                                            ...
                                            <div class="mb-4 w-100">
                                                <div class="progress" style="height: 6px;">
                                                    <div class="progress-bar bg-primary" role="progressbar"
                                                        style="width: 31.3%" aria-valuenow="25" aria-valuemin="0"
                                                        aria-valuemax="100"></div>
                                                </div>
                                                <small>React</small>
                                                <small>React</small>
                        ...
                        <li class="timeline-item">
                            <span class="timeline-indicator timeline-indicator-danger aos-init aos-animate"
                                data-aos="zoom-in" data-aos-delay="200">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="collapse" id="collapseExample">
                                        <ul class="list-group list-group-flush mt-4">
                                            ...
                                            <li class="list-group-item d-flex justify-content-between flex-wrap">
                                                <span>
                                                    This Years's Total Balance : <span
                        ...
                        <li class="timeline-item">
                            <span class="timeline-indicator timeline-indicator-warning aos-init" data-aos="zoom-in"
                                data-aos-delay="200">
                                <i class="ti ti-chart-donut-2"></i>
                            </span>
                            <div class="timeline-event card p-0 aos-init" data-aos="fade-left">
                                <h6 class="card-header">Snacks</h6>
                                <div class="card-body">
                                    <div class="d-flex flex-sm-row flex-column">
                                        <img src="../../assets/img/elements/13.jpg" class="rounded me-4 mb-sm-0 mb-2"
                        ...
                        <li class="timeline-item timeline-item-right">
                            <span class="timeline-indicator timeline-indicator-info aos-init" data-aos="zoom-in"
                                data-aos-delay="200">
                        ...
                        <li class="timeline-item timeline-item-left">
                            <span class="timeline-indicator timeline-indicator-primary aos-init" data-aos="zoom-in"
                                data-aos-delay="200">
                                <i class="ti ti-barbell"></i>
                            </span>
                            <div class="timeline-event card p-0 aos-init" data-aos="fade-right">
                                <div class="card-header border-0 d-flex justify-content-between">
                        ...
                        <li class="timeline-item">
                            <span class="timeline-indicator timeline-indicator-success aos-init" data-aos="zoom-in"
                                data-aos-delay="200">
                        ...
                        <li class="timeline-item">
                            <span class="timeline-indicator timeline-indicator-danger aos-init" data-aos="zoom-in"
                                data-aos-delay="200">
