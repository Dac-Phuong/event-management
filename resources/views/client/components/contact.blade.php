        ...
        <section class="contact-section">
            ...
            <div class="container">
                <div class="center-content section-title my-5">
                    <h2 class="text-gradient middle-content stroke-text mx-2" data-aos="zoom-in" data-aos-duration="1000">LIÊN HỆ VỚI CHÚNG TÔI</h2>
                    <div class="divider" data-aos="zoom-in" data-aos-duration="1000"></div>
                    <p  class="text-center m-auto" style="max-width: 700px;" data-aos="fade-up" data-aos-duration="1000">Hãy liên hệ với Tập đoàn Anh Sơn Group để được tư vấn về các dịch vụ phù hợp với doanh nghiệp của
                        bạn</p>
                </div>
                            ...
                            <div class="contact-info" data-aos="fade-up" data-aos-duration="1000">
                                ...
                                <div class="info-item">
                                    ...
                                    <div class="info-content">
                                        <h4>Địa Chỉ</h4>
                                        <p class="contact-address">Số 27 phố Mai Phúc, phường Phúc Đồng, quận Long Biên, Hà Nội</p>
                                    </div>
                                </div>
                                ...
                                <div class="social-links">
                                    <a class="social-fanpage" target="_blank" href="#"><i class="fab fa-facebook-f"></i></a>
                                    <a class="social-zalo" target="_blank" href="#"><span style="font-size: 12px;">Zalo</span></a>
                                    <a class="social-youtube" target="_blank" href="#"><i class="fab fa-youtube"></i></a>
                                    <a class="social-telegram" target="_blank" href="#"><i class="fab fa-telegram"></i></a>
                        ...
                        <div class="col-lg-7">
                            <div class="contact-form" data-aos="fade-up" data-aos-duration="1000">
                                <form id="contactForm" method="POST">
                                    ...
                                    <div class="mb-3">
                                        <label for="subject" class="form-label">Dịch vụ <span
                                                >*</span></label>
                                    ...
                                    <div class="text-center text-lg-start">
                                        <button type="submit" class="cta-button" data-aos="zoom-in" data-aos-duration="1000">
