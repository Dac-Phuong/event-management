 ...
 <section id="landingPricing" class="section-py">
     <div class="journey position-relative">
                     ...
                     <div class="statistics">
                         ...
                         <div class="card card-border-shadow-primary h-100" data-aos="fade-up">
                             <div class="card-body">
                                 ...
                                 <p class="mb-1">Tham gia sự kiện lớn nhỏ</p>
                             </div>
                         </div>
                         <div class="card card-border-shadow-primary h-100" data-aos="fade-up">
                             <div class="card-body">
         ...
         <div class="position-absolute left-0 w-100 d-none d-md-block" style="top:-50px; left: -22%;">
             <img src="{{ asset('assets/files/img/trong-dong.png') }}" class="img-fluid spin-slow" alt="image"
