            ...
            <div class="container">
                <div class="row align-items-center position-relative">
                    ...
                    <div class="col-lg-6 bg-white p-3 p-md-5 mt-3 mt-md-0 content-overlay"
                        ...
                        <p class="mb-2">
                            Thành lập từ năm 2006, đến nay đã gần 20 năm trưởng thành và phát triển, công ty Cổ phần
                            Quảng
                            cáo –
                        ...
                        <p class="mb-2">
                            Là nhà tư vấn giải pháp - Đối tác chiến lược về Truyền thông &amp; sự kiện cho các khách
                            hàng
                            trong
                            nước và
                            quốc tế tại khu vực Đông Nam Á. TẬP ĐOÀN ANH SƠN cũng vinh dự là đại diện duy nhất của Việt
                            Nam
                            chiến thắng
