<div class="modal fade" id="modal-recruitment" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form class="add-new-user pt-0" id="addRecruitment">
                <div class="modal-body">
                    <div class="mb-3">
                        <label class="form-label" for="recruitment-title">Tiêu đề</label>
                        <input type="text" class="form-control" name="title" id="recruitment-title">
                    </div>
                    <div class="mb-3">
...
@push('scripts')
    <script>
        $("#addRecruitment").submit(function(e) {
            e.preventDefault();
            let formData = new FormData($("#addRecruitment")[0]);
            const slug = $("#recruitment-title").val();
