...
@section('content')
    <h4 class="mb-0 py-3">
        <span class="text-muted fw-light">Bài viết /</span><span class="fw-medium"> Thêm bài viết</span>
    </h4>
    ...
    <div class="app-ecommerce">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3">
            ...
            <div class="d-flex flex-column justify-content-center">
                {{-- <h4 class="mb-1 mt-3">Tạo 1 bài viết mới</h4> --}}
            </div>
            <div class="d-flex align-content-center flex-wrap gap-3">
                <div class="d-flex gap-3">
                    <a class="btn btn-label-secondary" href="{{ route('news.index') }}">Quay lại</a>
                    <button class="btn btn-label-primary" id="btn-draft-save">Lưu nháp</button>
                </div>
                <button type="submit" class="btn btn-primary" id="btn-save">Đăng bài</button>
            </div>
        ...
        <form id="news-form" class="row">
            ...
            <div class="col-12 col-lg-8">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <div class="col"><label class="form-label" for="news-category">Loại bài viết</label>
                            ...
                            <div class="col"><label class="form-label" for="ecommerce-product-barcode">Ghim bài
                                ...
                                <div>
                                    <label class="switch switch-square">
                                        <input type="checkbox" name="is_pin" class="switch-input" />
                        ...
                        <div>
                            ...
                            <div class="form-control">
                                <textarea id="news-content" name="content" class="form-control">{!! old('content', '') !!}</textarea>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="text-center">
                            <div id="preview-image" style="height: 200px" class="my-2" style=""></div>
            ...
            <div class="col-12 col-lg-4">
                <x-seo input-title-id="news-title" />
            </div>
            <!-- /Second column -->
        </form>
    </div>
